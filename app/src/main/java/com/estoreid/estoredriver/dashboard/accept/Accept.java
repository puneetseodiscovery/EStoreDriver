package com.estoreid.estoredriver.dashboard.accept;
...
public class Accept extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void listerners() {
        accept_backbt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Accept.this, MainActivity.class);
    ...
    private void init() {
        ...
        accept_backbt = findViewById(R.id.accept_backbt);
    }
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        ...
                        task.addOnSuccessListener(new OnSuccessListener<Location>() {
                            ...
                            public void onSuccess(Location location) {
                                ...
                                if (location == null) {
                                    statusCheck();
                                    Toast.makeText(Accept.this, "Unable to get Location", Toast.LENGTH_SHORT).show();
                                } else {
                                ...
                                Geocoder geocoder = new Geocoder(Accept.this, Locale.getDefault());
                                try {
                                    ...
                                    if (mapView != null) {
                                        ...
                                        mapView.onResume();
                                        mapView.getMapAsync(Accept.this);
                                    }
                                } catch (IOException e) {
                                    e.printStackTrace();
                                }
                        ...
                        task.addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Accept.this, "Location Not Found...,Enter Location Manually...", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
